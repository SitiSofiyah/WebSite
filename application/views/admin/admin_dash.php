            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    <li style="padding: 10px 0 0;">
                        <a href="<?php echo base_url ('index.php/admin')?>" class="waves-effect active"><i class="fa fa-clock-o fa-fw" aria-hidden="true"></i><span class="hide-menu">Dashboard</span></a>
                    </li>
                     <li>
                    ...
                    <li>
                        <a href="<?php echo base_url ('index.php/carousel')?>" class="waves-effect"><i class="fa fa-photo fa-fw" aria-hidden="true"></i><span class="hide-menu">Carousel</span></a>
                    </li>
