...
<body>
	...
	<header class="header-section">
		<div class="header-warp">
			...
			<div class="header-right">
				<p><span>Information</span> <i class="fa fa-phone"></i> 652-345 3222 11</p>			
			</div>
		</div>
	</header>
	<!-- Header section end -->
	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			...
			<div class="hs-item set-bg" data-setbg="<?php echo base_url('assets/carousel/'.$row['image']) ?>">
				<div class="hs-content">
					<div class="hsc-warp">
						<h2><?php echo $row['title'] ?><span>.</span></h2>
	...
	<section class="inter-section spad">
		<div class="container">
			...
			<div class="text-center">
				<img src="<?php echo base_url('assets/img/sign.png')?>" alt="">
			</div>
		</div>
	</section>
	<!-- Intro section end -->
	...
	<section class="testimonials-section spad pb-0 set-bg" data-setbg="<?php echo base_url('assets/img/review-bg.jpg')?>">
		<div class="container">
